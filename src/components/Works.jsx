...
import Cloneim from '../assets/works/Cloneimg.png';
...
const PROJECTS = [
  ...
  },
  {
    ...
    category: 'AI / GenAI',
    year: '2026',
    description: 'Atelier AI is an AI-powered architecture assistant that transforms natural language descriptions into architectural concepts. Users can generate multiple floor plan layouts from their requirements and create realistic exterior visualizations, streamlining the journey from initial idea to architectural design using generative AI.',
  ...
  },
  {
    ...
    year: '2024',
    description:
      'A production-style analytics dashboard with authentication, role-based access, and real-time data visualization, built end-to-end with React and Node.js.',
  ...
  },
  {
    ...
    year: '2024',
    description:
      'This very site — a scroll-driven, motion-heavy portfolio built with React, Tailwind, AOS, and Framer Motion, focused on performance and tactile micro-interactions.',
  ...
  },
  {
    ...
    year: '2024',
    description:
      'A live multi-user editing tool with WebSocket-based sync, presence indicators, and conflict-free state merging.',
  ...
  },
  {
    ...
    year: '2023',
    description:
      'An automated content generation pipeline chaining prompt templates, moderation checks, and structured JSON outputs for downstream apps.',
...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative rounded-4xl p-2  transition-all duration-700 hover:-translate-y-2 ${
        isHovered
          ? 'bg-red-600 shadow-[0_25px_60px_rgba(255,42,42,0.35)]'
          : 'bg-transperant border border-gray-200 shadow-[0_15px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)]'
      }`}
    >
      {/* Hole punch, same detail as Services TagCard */}
      <div className="w-5 h-5 bg-linear-to-br from-gray-300 to-gray-100 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] absolute top-4 left-1/2 -translate-x-1/2 border border-gray-300 z-20 flex items-center justify-center">
        <div className="w-2 h-2 bg-gray-800 rounded-full opacity-20"></div>
      </div>

      {/* Media */}
      <div className="w-full h-60 mt-8 rounded-3xl overflow-hidden relative bg-gray-900">
        {project.image ? (
          <img
            src={project.image}
            alt={project.title}
          ...
          <div className="w-full h-full flex items-center justify-center bg-linear-to-br from-gray-800 to-black">
            <span className="text-white/20 text-6xl font-black">{project.number}</span>
          </div>
        )}
        ...
        >
          <a
            ...
            className="w-11 h-11 rounded-full bg-white text-black flex items-center justify-center hover:scale-110 transition-transform duration-300"
      ...
      <div className="flex flex-col p-6 flex-1">
        ...
        <p
          className={`text-sm leading-relaxed font-medium mb-6 flex-1 transition-colors duration-700 ${
    ...
    >
      <div className="max-w-6xl mx-auto relative">
        ...
        <div
          data-aos="fade-up"
          data-aos-delay="200"
          className="mt-20 flex flex-col md:flex-row items-center justify-between gap-8 bg-[#0a0a0a] rounded-4xl p-10 md:p-14 relative overflow-hidden"
        >
          <div className="absolute top-6 right-8 text-white opacity-10">
